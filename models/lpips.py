...
# LPIPS (Zhang et al., CVPR 2018). vgg.pth holds the linear head weights.
import torch
...
class LPNet(nn.Module):
    def __init__(self):
        ...
        # Resolve relative to this file so the code runs from any working directory.
        model_path = os.path.abspath(
            os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'vgg.pth'))
